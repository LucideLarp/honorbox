...
The fulfillment bot stores, in a private repository: the Stripe session
reference and the GitHub username it invited. Nothing about your purchase is
published anywhere.

## Data requests

To have your fulfillment records deleted (after any refund window), email
honorbox@proton.me or reply to your Stripe receipt. Stripe retains its own
transaction records as required by financial regulation, which the seller
cannot delete.
