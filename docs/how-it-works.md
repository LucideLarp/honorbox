# How HonorBox works (and its honest limits)
...
that's a server, TLS, retries, signature verification, and a place for secrets
...
| GitHub cron delayed | Delivery late by minutes–hours; confirmation message sets expectation |
